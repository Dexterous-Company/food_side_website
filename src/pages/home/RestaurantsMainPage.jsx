  ...
  <div className="max-w-7xl mx-1 md:mt-0 mt-3 sm:mx-auto rounded-2xl border border-gray-200 bg-white p-8 text-center">
    <div className="flex flex-col items-center">
      ...
      <p className="text-gray-500 mb-4">
        We couldn't find any restaurants for {deliveryPointLabel || 'this delivery point'}.
...
export default function RestaurantsMainPage({ layout = "scroll" }) {
  ...
  const { selectedDeliveryPoint } = useSelector((state) => state.delivery || { selectedDeliveryPoint: null });
  ...
  if (error || restaurants.length === 0) {
    return <EmptyState deliveryPointLabel={deliveryPointLabel} onRetry={fetchRestaurants} />;
  }
