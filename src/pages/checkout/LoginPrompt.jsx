  ...
  const handleCompleteRegistration = async () => {
    ...
    try {
      ...
      if (createResult.success) {
        const createdUser =
          createResult.user || createResult.data || newUserData;
  ...
  if (showRegistrationForm) {
    return (
      <div
        className={
          isDesktop
            ? "mb-4 p-4 bg-gray-50 rounded-xl border border-gray-200"
            : "mb-4 p-4 bg-gray-50 rounded-xl border border-gray-200"
        }
      >
        {toastMessage && (
          <div
            className={`fixed top-4 right-4 z-50 flex items-center gap-1.5 rounded-lg px-3 py-2 shadow-lg ${
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 rounded-lg border-2 border-gray-300 py-2 text-xs font-semibold text-gray-700 transition hover:bg-gray-100 flex items-center justify-center gap-1"
            >
            ...
            <button
              ...
              className="flex-1 rounded-lg bg-[#ff581b] py-2 text-xs font-semibold text-white transition hover:bg-gray-900 disabled:opacity-50"
            >
      ...
      >
        ...
        <div className="text-center mb-4">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-orange-100">
            <FaLock className="h-6 w-6 text-[#ff581b]" />
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 rounded-lg border-2 border-gray-200 bg-white px-4 py-2 focus-within:border-[#ff581b]">
              ...
              <input
                ...
                maxLength={6}
                className="w-full bg-transparent text-center text-base tracking-widest outline-none"
                placeholder="••••••"
                autoFocus
              />
            </div>
