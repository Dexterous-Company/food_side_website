  ...
  const AboutUs = () => {
    ...
    <div className="flex gap-12 animate-ticker w-max">
      {[...tickerItems, ...tickerItems].map((text, i) => (
        <div
          key={i}
          className="flex items-center gap-12 text-white text-xs font-bold uppercase tracking-wider whitespace-nowrap"
        >
          {text}
          ...
          <div className="grid md:grid-cols-2 min-h-[540px]">
            <div className="bg-[#ff581b] p-8 md:p-16 relative overflow-hidden flex flex-col justify-center">
              <div className="relative z-10">
                ...
                <Link  href="https://play.google.com/store/apps/details?id=com.foodside" className="bg-black text-white rounded-full py-4 px-8 inline-flex items-center gap-2 hover:bg-white hover:text-black transition-all">
                  Get the App
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
